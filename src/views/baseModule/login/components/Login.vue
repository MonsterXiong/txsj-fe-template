<template>
  <div class="login" style="position: relative">
    <img style="position: absolute; width: 100%; height: 100%; z-index: 1" src="static/image/base/bg-login.png" alt="" />
    <div style="position: absolute; width: 100%; height: 100%; z-index: 3">
      <h1>{{ systemName }}</h1>
      <div class="login-wrapper">
        <div class="login-card">
          <h2>登录</h2>
          <el-form ref="formAccount" :model="formAccount" status-icon :rules="formAccountRules" label-width="80px">
            <el-form-item label="用户名" prop="account">
              <el-input v-model="formAccount.account" size="medium">
                <i slot="prefix" class="el-input__icon el-icon-user login-icon"></i>
              </el-input>
            </el-form-item>
            <el-form-item label="密码" prop="pass">
              <el-input v-model="formAccount.pass" type="password" size="medium" @keyup.enter.native="submitForm">
...
.login {
  ...
  width: 100%;
  height: 100%;
  //background: url(/static/image/base/bg-login.png) no-repeat;
  h1 {
    padding: 0;
    margin: 0;
    padding-top: 40px;
