<template>
  <div class="login" style="position: relative">
    <img style="position: absolute; width: 100%; height: 100%; z-index: 1; background-color: #dfeff6" src="static/image/base/login4/bg-login.png" alt="" />
    <div style="position: absolute; width: 100%; height: 100%; z-index: 3">
      <div class="login-wrapper">
        <div class="login-card">
          <img style="position: absolute; width: 100%; height: 100%; left: 0; top: 0" src="static/image/base/login4/bg-card.png" alt="" />
          <div class="title">
